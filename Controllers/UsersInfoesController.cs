...
namespace DoAn.Controllers
{
    ...
    public class UsersInfoesController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<UsersInfo>> GetUsersInfo(string id)
        {
          if (_context.UsersInfos == null)
          {
              return NotFound();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutUsersInfo(string id, UsersInfo usersInfo)
        {
        ...
        public async Task<ActionResult<UsersInfo>> PostUsersInfo(UsersInfo usersInfo)
        {
          if (_context.UsersInfos == null)
          {
              return Problem("Entity set 'DoAnContext.UsersInfos'  is null.");
          }
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteUsersInfo(string id)
        {
            if (_context.UsersInfos == null)
            {
                return NotFound();
        ...
        private bool UsersInfoExists(string id)
        {
